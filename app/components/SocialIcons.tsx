...
const SocialIcons = () => {
  return (
    <div className="top-[30vh] fixed">
      <Link href={"https://www.linkedin.com/in/muhammad-saim-624488217/"} target={"_blank"}>
      ...
      <Link href={"https://github.com/MuhammadSaim786"} target={"_blank"}>
      ...
      <Link href={"https://medium.com/@saim66381"} target={"_blank"}>
